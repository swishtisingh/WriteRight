document.addEventListener('DOMContentLoaded', function () {
    ...
    const resultContainer = document.getElementById('grammer');
    ...
    submitButton.addEventListener('click', function (e) {
      ...
      fetch('http://127.0.0.1:5000/grammer', {
        method: 'POST',
        headers: {
        ...
        .then(data => {
          ...
          console.log(data);
          //alert(data);
          resultContainer.textContent = `${data.grammer_text}`;
          submitButton.disabled = false;
          submitButton.innerHTML = "grammer";
        })
        .catch(error => {
